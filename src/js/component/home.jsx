...
const Home = () => {
  ...
  {listaTareas.map((tarea, id) => <li id="cruz" className="list-group-item fs-5 d-flex justify-content-between"  key={id}>{tarea}<button id="eliminarcruz" type="button" className="btn-close fs-6 mt-1 " aria-label="Close" onClick={()=> eliminarTareas(id)}></button></li>)}
